...
**Ограничение снимается по измеренному базису**, не по умозрению —
...
*(Решение восстановлено `GAPS_CLOSE_26`: оно было потеряно при
переписывании корпуса, а не отменено — встречный якорь в backlog
оставался живым.)*
