...
- **Строка источника не угадывается**: какой бар секундного разрешения
  отдаёт источник и есть ли он вовсе на нужных парах котировки — факт,
  который добывается прогоном, а не выводится. До ответа строка в
