...
- detect **available equity** (balanceExternalSnapshot)
...
Order of calls is deliberate: **positions → orders → algos → balanceExternalSnapshot**.
...
### Step 4 — Fetch balanceExternalSnapshot/equity
...
flowchart TD
  ...
  D --> E[GET balanceExternalSnapshot]
...
- Save a “ReconcileRun” record with:
    - timestamp
    - instrument
    - snapshots: positions/orders/algos/balanceExternalSnapshot (or hashes)
