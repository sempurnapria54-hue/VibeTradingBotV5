...
Как устроен процесс добычи и поддержания целостности свечной
истории: оркестрация `CandleJob`, цикл статусов `CandleGroup`,
политика глубины/целостности, координация онбординга инструмента.
