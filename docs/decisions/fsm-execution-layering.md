...
системной тропы **отвергнута**: носителей последовательности два, и это не
дубль — kill-switch системный и задаёт последовательность сам, штатный выход
идёт по условиям и действиям стратегии. Инвариант порядка записан **один
раз** — `docs/rules/exit-teardown-order.md`.
