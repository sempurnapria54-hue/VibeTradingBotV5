...
> Гранулярность файлов под вопросом — CMD-Q1
> (`.claude/work/questions/open-questions.md`): подтипы могут быть
> вынесены в отдельные файлы либо сгруппированы. До решения — один файл
> с разделами.
