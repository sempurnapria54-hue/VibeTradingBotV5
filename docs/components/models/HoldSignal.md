...
серии»); `CLOSE_OUTCOME_UNDETERMINED` / `RECONCILIATION_OPERAND_MISSING`
— нарушение контракта в добытой записи закрытия (`exchange(...)`, H7/H10
`DOCS_CHECK_14`, реестр — `docs/models/domain/other/AnomalyReport.md`);
