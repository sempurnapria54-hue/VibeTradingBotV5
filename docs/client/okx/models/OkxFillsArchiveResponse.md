...
Raw OKX response endpoint'ов `POST /api/v5/trade/fills-archive`
...
см. `OkxFillResponse.md` / `okx-fills-mapping.md`).

Persisted-сущность `TradeFillsArchive` на первом этапе **не вводим**
(см. OKX-Q2 в `.claude/work/questions/open-questions.md`). Mapping и
контракт — `docs/client/okx/rules/okx-fills-archive-mapping.md`.
