 ...
 * время оценки. Собирается потребителем из готовых результатов; evaluator
 * по свечам ничего не считает. Runtime-объект (deal-контекст —
 * Position/Order-факты — добавится с кластером сделки).
