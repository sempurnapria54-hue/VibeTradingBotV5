...
7. **Backlog.** Check:
   - If session work closed an item in `docs/planning/backlog.md` — has it been moved to the "Закрытые" section with date and link to ADR/commit?
   - If new open questions surfaced during work and weren't resolved on the spot — have they been added to `docs/planning/backlog.md` with a clear priority and source?
