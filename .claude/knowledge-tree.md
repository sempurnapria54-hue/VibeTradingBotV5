...
│   │   └── snapshot-v96.md — Где мы сейчас? (актуальный; старые — в work/history/snapshots/)
│   ├── templates/
...
│       │   ├── phase-1-step-7-docs-check-33/ — (приложения прогона `_33`: мандат линз и отчёты линз; прогон не завершён)
│       │   ├── corpus-rewrite-mapping.md — Куда переехал каждый фрагмент при переписывании корпуса?
│       │   └── risk-contour-design.md — Как спроектирован риск-контур шага 7?
