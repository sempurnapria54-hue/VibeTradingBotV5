...
│   │   └── snapshot-v93.md — Где мы сейчас? (актуальный; старые — в work/history/snapshots/)
│   ├── templates/
...
│   │   │       ├── OkxAlgoOrderResponse.md — Какие поля у нативной модели условной заявки источника?
│   │   │       ├── OkxBalanceResponse.md — Какие поля у нативной модели баланса источника?
│   │   │       ├── OkxFillResponse.md — Какие поля у OKX fill response (одна сделка / одно исполнение)?
│   │   │       ├── OkxFillsArchiveResponse.md — Какие поля у нативных моделей выгрузки сделок исполнения источника?
│   │   │       ├── OkxOrderResponse.md — Какие поля у нативной модели заявки источника?
│   │   │       ├── OkxPositionResponse.md — Какие поля у нативной модели позиции источника?
│   │   │       ├── OkxPositionsHistoryResponse.md — Какие поля у нативной модели истории позиций источника?
│   │   │       ├── OkxTickerResponse.md — Какие поля у нативной модели котировки источника?
