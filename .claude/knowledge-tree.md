...
│       ├── progress/ — На каком шаге мы в этой активной операции? (лежат хроника шага 11 фазы 2, части его прогона `DOCS_CHECK_1` и отчёт разбора оборванной единицы; отчёты закрытых единиц — в `history/`)
