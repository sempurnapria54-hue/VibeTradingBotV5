...
│   │   └── snapshot-v106.md — Где мы сейчас? (актуальный; старые — в work/history/snapshots/)
│   ├── templates/
...
│       │   ├── phase-1-step-7-chronicle.md — Что происходило на шаге 7 фазы 1 после смены концепции?
│       │   ├── phase-1-step-7-docs-check-26.md — Какие пробелы концепции нашёл прогон DOCS_CHECK_26 шага 7 фазы 1?
│       │   ├── phase-1-step-7-docs-check-26/ — (приложения прогона: отчёты семи линз и слой верификации CC)
│       │   ├── phase-1-step-7-gaps-close-26.md — Чем закрыт каждый узел прогона DOCS_CHECK_26?
│       │   ├── phase-1-step-7-docs-check-27.md — Какие пробелы концепции нашёл прогон DOCS_CHECK_27 шага 7 фазы 1?
│       │   ├── phase-1-step-7-docs-check-27/ — (приложения прогона: отчёты семи линз и слой верификации CC)
│       │   ├── phase-1-step-7-gaps-close-27.md — Чем закрыт каждый узел прогона DOCS_CHECK_27?
│       │   ├── phase-1-step-7-gaps-close-27/ — (приложения закрытия: отчёты девяти узлов и семи проходов мини-петли критики)
│       │   ├── phase-1-step-7-docs-check-28.md — Какие пробелы концепции нашёл прогон DOCS_CHECK_28 шага 7 фазы 1?
│       │   ├── phase-1-step-7-docs-check-28/ — (приложения прогона: отчёты семи линз и слой верификации CC)
│       │   ├── phase-1-step-7-gaps-close-28.md — Чем закрыт каждый узел прогона DOCS_CHECK_28?
│       │   ├── phase-1-step-7-gaps-close-28/ — (приложения закрытия: вход, отчёты узлов и проходы мини-петли критики)
│       │   ├── phase-1-step-7-docs-check-29.md — Какие пробелы концепции нашёл прогон DOCS_CHECK_29?
│       │   ├── phase-1-step-7-docs-check-29/ — (приложения прогона: мандат линз, отчёты семи линз, два прохода слоя верификации CC)
│       │   ├── phase-1-step-7-gaps-close-29.md — Чем закрыт каждый узел прогона DOCS_CHECK_29?
│       │   ├── phase-1-step-7-docs-check-30.md — Какие пробелы концепции нашёл прогон DOCS_CHECK_30?
│       │   ├── phase-1-step-7-docs-check-30/ — (приложения прогона: мандат линз и отчёты семи линз)
│       │   ├── phase-1-step-7-gaps-close-30.md — Чем закрыт каждый узел прогона DOCS_CHECK_30?
│       │   ├── phase-1-step-7-docs-check-31.md — Какие пробелы концепции нашёл прогон DOCS_CHECK_31?
│       │   ├── phase-1-step-7-docs-check-31/ — (приложения прогона: мандат линз и отчёты семи линз)
│       │   ├── phase-1-step-7-gaps-close-31.md — Чем закрыты пробелы, найденные прогоном DOCS_CHECK_31?
│       │   ├── phase-1-step-7-docs-check-32.md — Какие пробелы концепции нашёл прогон DOCS_CHECK_32?
│       │   ├── phase-1-step-7-docs-check-32/ — (приложения прогона: мандат линз и отчёты семи линз)
│       │   ├── phase-1-step-7-gaps-close-32.md — Чем закрыты пробелы, найденные прогоном DOCS_CHECK_32?
│       │   ├── phase-1-step-7-docs-check-33.md — Какие пробелы концепции нашёл прогон `_33`?
│       │   ├── phase-1-step-7-docs-check-33/ — (приложения прогона `_33`: мандат линз и отчёты семи линз)
│       │   ├── phase-1-step-7-gaps-close-33.md — Как закрыты 30 гейтящих находок прогона `_33`?
...
│       │   ├── phase-1-step-7-code-pass-expiration.md — Что сделано ночной пачкой ходов 2026-09-02?
