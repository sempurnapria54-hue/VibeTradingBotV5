...
│       ├── progress/ — На каком шаге мы в этой активной операции? (шаг 10 фазы 2 закрыт; лежит только отчёт его перехода — см. бэклог)
...
├── services/ — (Код единиц развёртывания; индексируется только указатель каталога.)
