...
│   │   └── snapshot-v114.md — Где мы сейчас? (актуальный; старые — в work/history/snapshots/)
│   ├── templates/
...
│       ├── progress/ — На каком шаге мы в этой активной операции? (пусто: артефакты шага 7 перенесены в history/2026-09-03-phase-1-step-7-deals-and-pnl/)
