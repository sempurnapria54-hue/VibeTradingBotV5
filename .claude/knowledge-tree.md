...
│   │   └── snapshot-v127.md — Где мы сейчас? (актуальный; старые — в work/history/snapshots/)
│   ├── templates/
...
│       │   └── phase-2-step-5-chronicle.md — Что сделано на шаге 5 фазы 2 и что осталось до его закрытия?
