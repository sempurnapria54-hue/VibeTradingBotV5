...
│       ├── progress/ — На каком шаге мы в этой активной операции? (лежат хроника шага 12 фазы 2, отчёт ревью его концепции, ревизия существующего набора тестов, по каждому предмету отчёты петли — адверсариального ревью кейсов, правки их автором и перепроверки исправленного, по отчёту на круг)
