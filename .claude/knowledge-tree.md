...
- Не индексируются: содержимое `work/history/` и
  ...
  **содержимое** деревьев кода и манифестов — `services/`,
  `web/`, `deploy/`, `tests/`. У каждого такого дерева индексируется
...
│   │   ├── defects-fixed-in-finding-step.md — Почему дефект, вскрытый тестами или ревью шага, чинится в том же шаге, а не паркуется в бэклог?
...
│   │   ├── 2026-09-21-step-12-pace-analysis.md — Куда по фактам уходит время шага 12 и какие меры ускоряют работу с тестами без потери качества?
│   │   ├── 2026-09-23-step-12-trading-triage-core.md — Какое торговое последствие для капитала несёт каждая секция бэклога, которую шаг 12 фазы 2 завёл по торговому ядру и границе с биржей?
│   │   ├── 2026-09-23-step-12-trading-test-expectations.md — Какие ожидания тест-кейсов шага 12 фазы 2 закрепляют торгово-опасное поведение и каких торгово-критичных сценариев в кейсах нет?
│   │   ├── 2026-09-23-step-12-trading-triage-strategy.md — Какое торговое последствие несёт каждая секция бэклога, заведённая шагом 12 фазы 2 по сигналу, определению стратегии и рыночным данным?
│   │   ├── 2026-09-24-step-12-test-focus-audit-box-b1-b2.md — Какие находки дал проход фокуса `test` по группам B1-B2 чёрного ящика `audit` 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-audit-box-b7-b8.md — Какие находки дал проход фокуса `test` по группам B7-B8 чёрного ящика `audit` 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-audit-box-b9-b11.md — Какие находки дал проход фокуса `test` по группам B9-B11 чёрного ящика `audit` 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-bff-auth-connector.md — Какие находки дал проход фокуса `test` по тестам `bff`, `auth` и `connector-okx` 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-core-calc-fsm.md — Какие находки дал проход фокуса `test` по юнитам `calc` и `fsm` `trading-core` 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-core-risk-safety.md — Какие находки дал проход фокуса `test` по юнитам риска и защитных ступеней `trading-core` 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-durable-reception-units.md — Какие находки дал проход фокуса `test` по юнитам durable-приёма `audit` и `statistics` 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-e2e-core-units.md — Какие находки дал проход фокуса `test` 2026-09-24 по сквозному набору `tests/` и по юнитам ядра, которые прошлый проход не прочитал?
│   │   ├── 2026-09-24-step-12-test-focus-market-data-box.md — Какие находки дал проход фокуса `test` по коду чёрного ящика `market-data` 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-statistics-box.md — Какие находки дал проход фокуса `test` по группам B7-B10 чёрного ящика `statistics` 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-statistics-box-rest.md — Какие находки дал проход фокуса `test` по группам B1-B2, B5-B6 и B13 чёрного ящика `statistics` 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-reception-box-b3-b6.md — Какие находки дал проход фокуса `test` по группам B3-B6 ящика `audit` и B3-B4 ящика `statistics` 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-shared-units.md — Какие находки дал проход фокуса `test` по юнитам `market-data`, общих артефактов и навеса JSONB 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-strategies.md — Какие находки дал проход фокуса `test` по тестам `strategies`, `common/strategy-engine` и `common/model/domain` 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-trading-core-box-b1-b2-b9-b11.md — Какие находки дал проход фокуса `test` по группам B1-B2 и B9-B11 чёрного ящика `trading-core` 2026-09-24?
│   │   ├── 2026-09-24-step-12-test-focus-trading-core-box-b3-b4-b7-b8.md — Какие находки дал проход фокуса `test` по группам B3-B4 и B7-B8 чёрного ящика `trading-core` 2026-09-24?
│   │   └── 2026-09-24-step-12-test-focus-trading-core-box-b5-b6.md — Какие находки дал проход фокуса `test` по группам B5-B6 чёрного ящика `trading-core` 2026-09-24?
...
│   ├── rules/ — Какое у нас правило? (ядро с `tier: core` грузится всегда, правило с `paths:` — по чтению файла по маске; критерий — строка `.claude/rules/` в `structure.md`)
...
│   │   ├── long-run-wait.md — Какое правило ожидания долгого прогона (сборка, тесты, реактор)?
...
│   │   ├── environment-commands.md — Как исполнять команды сборки, прогона и доступа к секретам в этой среде?
...
│   ├── tests/ — Чем проверяется построенное?
│   │   ├── case-material/connector-okx.md — Какой материал добыт для кейсов чёрного ящика `connector-okx`?
│   │   ├── test-suite.md — Как устроен и как запускается набор тестов системы?
│   │   └── cases/ — Какие тест-кейсы у этого предмета? (наполняется под-шагом 1 `CODE` тестового шага)
│   │       ├── audit.md — Какие тест-кейсы у сервиса `audit`?
│   │       ├── auth.md — Какие тест-кейсы у сервиса `auth`?
│   │       ├── bff.md — Какие тест-кейсы у сервиса `bff`?
│   │       ├── bff-perimeter-logic.md — Какие тест-кейсы у чистой логики периметра?
│   │       ├── connector-okx.md — Какие тест-кейсы у сервиса `connector-okx`?
│   │       ├── domain-model-predicates.md — Какие тест-кейсы у предикатов общих доменных моделей?
│   │       ├── durable-reception.md — Какие тест-кейсы у логики приёма durable-потребителя?
│   │       ├── e2e-exit-and-close.md — Какие тест-кейсы у сквозной тропы «выход, сверка движений, терминал сделки»?
│   │       ├── e2e-perimeter-read.md — Какие тест-кейсы у сквозной тропы «токен → контекст тенанта → чтение и поток живых данных»?
│   │       ├── e2e-safety-teardown.md — Какие тест-кейсы у сквозной тропы «жёсткая ступень → снятие живого риска → отчёт и событие»?
│   │       ├── e2e-strategy-to-deal.md — Какие тест-кейсы у сквозной тропы «активация определения → сделка»?
│   │       ├── jsonb-overlay-roundtrip.md — Какие тест-кейсы у перечитывания записанного JSONB-навеса?
│   │       ├── market-data.md — Какие тест-кейсы у сервиса `market-data`?
│   │       ├── market-data-indicators.md — Какие тест-кейсы у расчётного слоя рыночных данных?
│   │       ├── okx-mapping.md — Какие тест-кейсы у слоя перевода форм источника OKX?
│   │       ├── platform-shared-logic.md — Какие тест-кейсы у форм общего артефакта периметра и их копий у сервисов?
│   │       ├── smoke-live.md — Какие тест-кейсы у дыма против тестового аккаунта площадки на стенде?
│   │       ├── statistics.md — Какие тест-кейсы у сервиса `statistics`?
│   │       ├── strategies.md — Какие тест-кейсы у сервиса `strategies`?
│   │       ├── strategy-definition-validation.md — Какие тест-кейсы у валидатора определения стратегии?
│   │       ├── strategy-engine-calculation.md — Какие тест-кейсы у расчётного слоя движка стратегий?
│   │       ├── strategy-engine-condition.md — Какие тест-кейсы у интерпретатора условий движка стратегий?
│   │       ├── trading-core-calc.md — Какие тест-кейсы у расчётного и резолверного слоя торгового ядра?
│   │       ├── trading-core-fsm.md — Какие тест-кейсы у слоя статусных машин сделки и транша?
...
│       ├── progress/ — На каком шаге мы в этой активной операции? (лежат хроника шага 12 фазы 2, отчёт ревью его концепции, ревизия существующего набора тестов, по каждому предмету отчёты ревью кейсов: у `auth` — отчёты петли, которую снял критерий апрува (адверсариальное ревью, правка автором, перепроверка — по отчёту на круг), у прошедших по критерию — отчёт апрува на предмет; у предмета, чей первый круг апрува не дал, — отчёт ревью и отчёт перепроверки сверх отчёта передачи; плюс отчёт захода, закрывшего развилку перечня предметов уровня 2, и отчёты передачи автора на ревью по новым предметам уровня 2 — по отчёту на предмет; отчёты фокусов `REVIEW` шага — по отчёту на фокус)
...
│   ├── concepts/ — Что хотим получить от этого предмета и зачем, где его границы?
│   │   └── testing.md — Что хотим получить от тестирования системы и зачем, где границы этого предмета?
...
│   └── README.md — Что кладётся в этот каталог?
├── tests/ — (Код сквозного набора; индексируется только указатель каталога.)
│   └── README.md — Что кладётся в этот каталог?
