...
│   │   └── snapshot-v122.md — Где мы сейчас? (актуальный; старые — в work/history/snapshots/)
│   ├── templates/
...
│       │   └── phase-2-step-1-chronicle.md — Что сделано на шаге 1 фазы 2 и что осталось до его закрытия?
