...
│   │   ├── loop-limited-to-corpus.md — Почему по итогам шести красных прогонов гейта выхода петля ограничена предметом, объёмом измерения и числом прогонов?
...
│   │   ├── mini-loop-verification-ceiling.md — Почему у мини-петли критики появился потолок верификаций числом?
...
│   │   ├── docs-loop-limits.md — Какое правило границ доковой петли?
│   │   ├── edit-kind-obligations.md — Какое правило обязанностей полноты у правки
│   │   │       корпусного захода?
...
│   │   ├── stopped-node-disposition.md — Какое правило разбора остановленного сигналом петли внутри закрытия?
...
│   │   ├── closure-population.md — Как построить популяцию при закрытии узла?
...
│       ├── progress/ — На каком шаге мы в этой активной операции? (лежат хроника шага 11 фазы 2, части его прогона `DOCS_CHECK_1`, отчёт разбора оборванной единицы, отчёты узлов 1-3 `GAPS_CLOSE_1` с заходами их мини-петель и отчёт концепт-прохода по перечню для чужого захода; отчёты закрытых единиц — в `history/`)
...
│   │   ├── audit-journal.json — Что журнал аудита объявляет читателю о своей полноте?
