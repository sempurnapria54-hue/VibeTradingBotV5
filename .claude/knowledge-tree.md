...
│       ├── progress/ — На каком шаге мы в этой активной операции? (лежит отчёт единиц размещения решений держателя 2026-09-12 — раздел `audit-statistics` и лента цикла; отчёты закрытых единиц — в `history/`)
