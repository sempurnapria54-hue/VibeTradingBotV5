...
│   │   ├── corpus-relocation-by-service.md — Почему корпус переезжает в монорепозиторий именно так (что, в каком порядке, по какой оси)?
...
│   │   └── snapshot-v121.md — Где мы сейчас? (актуальный; старые — в work/history/snapshots/)
│   ├── templates/
...
│       ├── progress/ — На каком шаге мы в этой активной операции? (пусто: активных операций нет)
