...
│   │   ├── deal-lifecycle.json — Какие переходы статуса сделки допустимы и какие инварианты держит терминал?
│   │   ├── deal-risk-numbers.json — Чему равны четыре числа риска сделки и по какому предикату отбираются их слагаемые?
│   │   ├── order-sizing.json — Какой размер получает действие после округления и что происходит, когда он меньше минимального?
