...
│       ├── progress/ — На каком шаге мы в этой активной операции? (лежит отчёт единицы разделения слоя сообщения и сведения общих артефактов; три отчёта закрытых единиц перенесены в `history/` 2026-09-12)
