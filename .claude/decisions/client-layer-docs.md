...
> (2026-05-28). `docs/client/<биржа>/` распущен; действующая раскладка
> живёт в `.claude/rules/structure.md` §«Таблица размещения». Файл
> сохранён как историческая запись.

## На какой вопрос отвечает этот файл

Почему exchange-specific факты (биржевые модели API, маппинги, правила
конкретной биржи) были выделены в каталог `docs/client/`.
