...
**Инвентарь — датированный замер момента ревизии, а не живой реестр.**
Снятые позже пробы в нём не вычёркиваются: снятие записывается в хронику
захода, который снял. *(с 2026-09-19)*
