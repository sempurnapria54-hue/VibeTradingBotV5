...
Единственный пункт на валидацию — **И-2** (runtime-подтверждение
cancel-пути advance в demo trading; естественная точка — `CODE`
шага 4). Прочее — перенос фактов, закрыт в доках. Гейт `CODE`
