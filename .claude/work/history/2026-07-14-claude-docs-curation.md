...
- **`.claude/knowledge-tree.svg`** — иллюстрация-обзор дерева
  (стилизованное дерево: ветви — каталоги с вопросами, листва —
  файлы, размер ∝ числу; history — опавшая листва, archive —
  бревно, src — камень, CLAUDE.md — золотой лист). Обновляется
  вместе с `knowledge-tree.md` при изменении состава каталогов.
