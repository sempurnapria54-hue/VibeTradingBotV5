...
Провизорные значения гистерезиса детекторов (1 тик у `A3`, `A10`; 2 тика у
остальных) назначены владельцем как **калибровка наблюдения**, не как
риск-аппетит; дом чисел и направление консервативности —
