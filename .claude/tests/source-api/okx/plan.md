...
- **Почему гейтит:** четвёртая пара сравнивает
  `externalLiquidationPenalty` **без отрицания**; если штраф приходит
  положительной величиной, Δ₄ = 2·|штраф| на **каждой** ликвидации ⇒
  `MISMATCHED` детерминированно на левом хвосте, то есть контроль
