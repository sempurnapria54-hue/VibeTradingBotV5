...
| `docs/rules/durable-consumer-reception.md` | сквозное: форму свидетельства о полноте приёма читают все durable-потребители, и носитель одного из них домом такой истины не бывает (`.claude/rules/carrier-levels.md`). Заведён узлом 4 `GAPS_CLOSE_1` шага 11 фазы 2: прежде форма жила у журнала аудита с доводом «предмета вне журнала нет», и раздел на два сервиса этот довод снял. Экземпляры и их особенности — у владельцев следствия приёма (`docs/models/domain/other/AuditRecord.md`, `docs/models/domain/other/StatisticsFact.md`) |
