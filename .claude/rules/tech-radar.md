...
| Kubernetes + Argo CD (GitOps) + GitHub Actions на self-hosted раннерах | развёртывание всех сервисов и данных; Actions собирает образы и меняет тег в манифестах, Argo CD приводит кластер (`docs/architecture/platform.md`) | `assess` (решение дизайн-прохода 2026-09-04; Flux — равная альтернатива, Argo выбран за интерфейс) |
