...
| TimescaleDB (расширение Postgres, оператор CloudNativePG) | временные ряды рыночных данных: свечи, OI, funding, срезы стакана, ликвидации | `assess` (дизайн-проход 2026-09-04; ClickHouse — по условию вытеснения записи аналитическими сканами). **Стоковый образ CloudNativePG расширения не несёт:** манифест кластера обязан назвать образ с TimescaleDB, иначе `create extension` упадёт на первой миграции `market-data` |
