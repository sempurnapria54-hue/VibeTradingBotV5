 ...
 * подключений к базе журнала у процесса было два и выбор принадлежал
 * читателю; теперь подключение одно, а форма оставлена затем, чтобы у
 * класса не было ни одного внедрённого поля: он и есть свёртка, и
...
public class JournalCompletenessService {
     ...
     * состояния вообще</b> (docs/spec/durable-reception.json,
     * {@code receptionLowerBound} через {@code pairsObserved}). Разница
