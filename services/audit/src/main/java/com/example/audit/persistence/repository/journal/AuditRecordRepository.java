...
public interface AuditRecordRepository extends JpaRepository<AuditRecordEntity, Long> {
     ...
     * конвенций (.claude/rules/codestyle.md §«Выборка данных: не тянем
     * сущность ради одного поля»): одним
     ...
     * среди СОХРАНИВШИХСЯ строк (docs/spec/durable-reception.json,
     * {@code consequenceSeriesStart}).
     *
