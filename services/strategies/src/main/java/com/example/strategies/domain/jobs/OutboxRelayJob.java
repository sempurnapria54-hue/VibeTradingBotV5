package com.example.strategies.domain.jobs;
 ...
 * брокера нет, outbox растёт линейно по числу переходов статуса. Гасить
 * его усечением нельзя — потерянное событие есть потерянный факт; гасит
 * его чистка опубликованных строк, и её глубина — отдельная величина с
...
public class OutboxRelayJob {
    ...
    @Scheduled(cron = "${jobs.outbox-relay.cron}")
    public void tick() {
