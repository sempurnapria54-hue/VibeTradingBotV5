 ...
 * чтение соседа идёт под сервисной идентичностью, а контекст тенанта
 * едет операндом вызова; подставить пользовательский токен значило бы
 * выдать служебное чтение за действие человека.
 *
