 ...
 *
 * <p><b>Журнальной строки отказа здесь нет, и это не пропуск:</b>
 * персистентный след отказов принадлежит {@code auth}
 * (.claude/rules/knowledge-ownership-by-service.md, строка
 * {@code AccessDenial}), а не всякому сервису, чей контур отказал.
 */
@Component
