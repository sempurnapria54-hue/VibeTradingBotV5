...
/**
 * После ПОЛНОГО цикла добычи ОТПРАВЛЕННАЯ сущность у источника не найдена,
 * и объяснить её финал безопасно нечем. Неотправленная в категорию не
 * входит: до площадки она не дошла, финал объясним, и броска у неё нет
