...
/**
 * Конвертация JSONB-навеса копии дерева стратегии: доменные
 * value-объекты ↔ сериализованный JSON колонок (параметры настроек,
...
public class StrategyJsonConverter {
    ...
    /** JSON параметров в подтип по типу индикатора строки-владельца. */
