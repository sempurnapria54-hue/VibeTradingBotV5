 ...
 *
 * <p><b>Область слагаемого и область блокировки не совпадают</b>, и это не
 * описка: блокировка шире — на принимающую корзину нераспознанного и на
 * все неисключённые строки при нерезолвимой расчётной валюте. Дом политики
 * асимметрии — docs/rules/pnl-reconciliation.md.
 */
@Service
...
public class DealResultCalculator {
    ...
    /**
     * Сумма net по эпизодам, а не число последнего: числитель обязан
     * покрывать те же заявки, что и знаменатель R.
     */
