 ...
 * материализована — все тропы эмиссии адресуют защиту родителя с
 * непустым наливом (kill-switch при живой позиции, штатный выход транша
 * после закрытия налитой экспозиции), а непустой налив её и
 * материализует. Инструмент берётся у
