...
public class AccountInstrumentState {
     ...
     * которую держатель назначает поверхностью ядра
     * (docs/rules/trading-constraints.md). Пусто ⇒ не назначено: действие,
     * создающее риск, отвергается преконтролем, а плечо площадке не пишется.
     */
