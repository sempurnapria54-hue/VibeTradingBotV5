...
import com.example.tradingcore.persistence.repository.PositionRepository;
...
/**
 * Граница domain ↔ persistence для эпизода позиции. Строка адресуется
...
public class PositionDataService {
    ...
    /** Эпизод по идентификатору; нет — исключение. */
