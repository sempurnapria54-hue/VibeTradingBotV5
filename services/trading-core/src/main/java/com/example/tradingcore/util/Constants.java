...
public class Constants {
    ...
    public class Audit {
         ...
         * значений актора»). Прежде здесь стояло имя сервиса, и в этой роли
         * оно неотличимо от имени принципала, когда принципалы станут
         * именованными — а область значений при втором субъекте поверхности
         * разворачивается именно в имена.
         *
         * <p>Константа вынесена в дом, потому что читателей у неё два:
         * поставщик актора и БЕЗОПАСНАЯ ВСТАВКА ПО КЛЮЧУ, которая идёт
         * нативным запросом и слушателей аудита не проходит вовсе
