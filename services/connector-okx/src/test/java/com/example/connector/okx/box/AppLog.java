 ...
 * могли бы выйти наружу ({@code B9.4}).
 *
 ...
 *
 * <p><b>У коннектора канал опаснее, чем у соседей:</b> здесь ключи —
 * операнд каждого приватного вызова, и путь их проходит через подпись,
 * перехватчик записи и сообщения отказов границы.
 */
final class AppLog {
