...
/**
 * Ящик со штатным положением осей окружения: окружение `dev`, допущен
 * контур `DEMO`, браузерная тропа настроена, хранилище живо.
 *
 ...
 * это своим подъёмом.
 */
abstract class SharedAuthBox extends AuthBox {
