...
public class Instrument extends Auditable {
     ...
     * {@code TRADE_BLOCKED} из перечня ещё не сняты.</b> Держал их монолит
     * фазы 1, удалённый 2026-09-16; сервисы этих значений не пишут и не
     * читают — ступень они берут из {@link SafetyRung}. Снятие взято в
     * работу — .claude/work/backlog.md §«Донорские значения в расколотых
     * перечнях общей библиотеки».
     */
    public enum Status {
