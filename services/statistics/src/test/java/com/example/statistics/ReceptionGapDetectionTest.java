 ...
 * смещений»; docs/rules/durable-consumer-reception.md
...
class ReceptionGapDetectionTest {
    ...
    private final ReceptionRebalanceListener rebalanceListener =
            new ReceptionRebalanceListener(receptionService, offsetTracker);
