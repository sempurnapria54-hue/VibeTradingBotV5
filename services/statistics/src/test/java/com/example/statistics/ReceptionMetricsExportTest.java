...
class ReceptionMetricsExportTest {
    ...
    private static final String AGE_SERIES = "statistics_reception_last_event_age_ms";
    ...
    void forgettingRemovesEverySeries() {
        metrics.replaceWith(List.of(fullyMeasured(CORE_TOPIC), fullyMeasured(SECOND_TOPIC)));
    ...
    void aPairGoneFromTheTickTakesItsSeriesAway() {
        ...
        assertThat(sample(AGE_SERIES, SECOND_TOPIC))
