...
class AggregateReadBoundariesTest {
    ...
    private static final String GROUP = "statistics.journal";
    ...
    private final ReceptionCompletenessService completenessService = mock(ReceptionCompletenessService.class);
    private final ReceptionCompletenessSource completenessSource =
            mock(ReceptionCompletenessSource.class);
    ...
    void setUp() {
        ...
        when(completenessService.completeness(any(), anyString(), any()))
                .thenReturn(new ReceptionCompleteness(MOMENT, Boolean.TRUE));
    }
