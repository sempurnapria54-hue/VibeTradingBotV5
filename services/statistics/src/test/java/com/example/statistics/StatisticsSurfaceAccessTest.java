...
@WebAppConfiguration
@ContextConfiguration(classes = StatisticsSurfaceAccessTest.SurfaceConfig.class)
class StatisticsSurfaceAccessTest {

    private static final String LIVENESS_PROBE = "/actuator/health";
    private static final String METRICS_SCRAPE = "/actuator/prometheus";
    private static final String ARBITRARY_CLOSED_PATH = "/api/v1/statistics/anything-at-all";
