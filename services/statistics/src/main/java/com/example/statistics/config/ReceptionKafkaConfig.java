...
/**
 * Клиент брокера у группы статистики — объявлен целиком, а не настроен поверх
 * умолчаний.
 *
 ...
 *       (docs/rules/durable-consumer-reception.md §«Форма — слушатель
...
public class ReceptionKafkaConfig {
     ...
     * нет» (docs/rules/durable-consumer-reception.md).
     */
    @Bean
