...
import com.example.statistics.mapping.ReceptionStateMapper;
 ...
 * ({@link StatisticsPersistenceConfig}).
 */
@Service
...
public class ReceptionStateSyncService {
     ...
     * (docs/spec/durable-reception.json, {@code lagAlertFires}).
     */
    @Transactional(readOnly = true, transactionManager = StatisticsPersistenceConfig.STATISTICS_TRANSACTION_MANAGER)
