 ...
 * (.claude/decisions/audit-statistics-split.md §«Границы шага» — это
 * контур, ВЫБОРКА на предмет и ограничения отбора; отложен состав
 * ЭКРАННЫХ операций). Общая форма строки на два зерна склеила бы непересекающиеся
...
public class AggregatePageApiResponse {
    ...
    private final ReceptionCompletenessApiResponse completeness;
}
