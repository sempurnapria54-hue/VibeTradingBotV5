package com.example.statistics.metrics;
 ...
 * (docs/spec/durable-reception.json, операнд {@code pairs}).
 */
@Component
public class ReceptionMetrics {
    ...
    public ReceptionMetrics(MeterRegistry registry) {
     ...
     * (docs/spec/durable-reception.json, {@code pairLagAlertFires}).
     */
