...
import com.example.statistics.persistence.model.ReceptionStateEntity;
import com.example.statistics.persistence.repository.ReceptionStateCompletenessQueries;
 ...
 * (docs/models/domain/other/StatisticsFact.md, таблица писателей):
 * <ul>
 ...
 * которому не нужна.
 */
public interface ReceptionStateRepository
        extends JpaRepository<ReceptionStateEntity, Long>, ReceptionStateCompletenessQueries {
     ...
     * заведён (docs/models/domain/other/StatisticsFact.md §«Отдельная
     ...
     * (docs/models/domain/other/StatisticsFact.md §«Третий исход сравнения
     ...
     * навсегда (docs/models/domain/other/StatisticsFact.md).
     */
    @Modifying
    @Query(nativeQuery = true, value = """
            update reception_states
     ...
     * события (docs/spec/durable-reception.json, {@code lastEventAgeMs}).
     *
