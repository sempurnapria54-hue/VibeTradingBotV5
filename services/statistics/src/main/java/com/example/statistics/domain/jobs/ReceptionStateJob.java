 ...
 * ({@link ReceptionMetrics}). Ряды пары живут ровно столько,
...
public class ReceptionStateJob {
    ...
    private final ReceptionMetrics receptionMetrics;
     ...
     * (docs/spec/durable-reception.json, {@code lagAlertThreshold}).
     */
