...
import com.example.statistics.persistence.repository.ReceptionStateRepository;
 ...
 * (docs/models/domain/other/StatisticsFact.md, таблица писателей): величины
...
public class ReceptionStateDataService {
    ...
    private final ReceptionStateRepository repository;
