...
import com.example.statistics.persistence.repository.ReceptionPairMomentRow;
 ...
 * приёма уезжает не строкой, а <b>полнотой</b> рядом с выдачей агрегатной
 * выборки (docs/rules/durable-consumer-reception.md §«Величины едут рядом с
 * числами, а не отдельным запросом») и рядами экспорта. Поэтому здесь один
 * метод, а не цепочка.
 *
