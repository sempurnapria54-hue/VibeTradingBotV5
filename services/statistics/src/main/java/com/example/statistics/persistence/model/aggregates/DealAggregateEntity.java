package com.example.statistics.persistence.model.aggregates;
 ...
 *
 * <p><b>Строка — проекция фактов, а не накопитель:</b> её числа
 * пересчитываются из ряда фактов целиком, и событием она не двигается. Отсюда
