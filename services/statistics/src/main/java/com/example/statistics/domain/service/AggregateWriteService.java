 ...
 * собраны из своих фактов одним проходом суток: половина записанной
 ...
 *
 * <p><b>Менеджер транзакций назван, а не подразумевается:</b> отображение
 * основным не помечено, и умолчания у выбора нет намеренно
