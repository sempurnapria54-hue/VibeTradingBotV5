 ...
 *
 * <p><b>Каталог наполняет ЛИСТИНГ, а не человек.</b> Каталог — зеркало
 * листинга площадки: заказать сбор по инструменту, которого в нём нет,
 * невозможно, потому что команда требования называет инструмент
