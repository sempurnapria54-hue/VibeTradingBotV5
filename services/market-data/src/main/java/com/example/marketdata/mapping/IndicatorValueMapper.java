...
import com.example.marketdata.persistence.model.AtrValueEntity;
import com.example.marketdata.persistence.model.BollingerBandsValueEntity;
import com.example.marketdata.persistence.model.EfficiencyRatioValueEntity;
import com.example.marketdata.persistence.model.EmaValueEntity;
import com.example.marketdata.persistence.model.IndicatorValueEntity;
import com.example.marketdata.persistence.model.MacdValueEntity;
...
/**
 * Маппинг значения индикатора domain ↔ persistence. Полиморфные ветви по
 * типу индикатора — через SubclassMapping (плоская SINGLE_TABLE на
