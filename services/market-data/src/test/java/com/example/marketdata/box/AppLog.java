 ...
 * которых поверхности нет вовсе: остановка тика на отказе доступа,
 * пропуск идентичности без калькулятора, пропуск идентичности структуры
 * без окна, отказ письма одной строки среза.
 *
 ...
 *
 * <p><b>Приёмник копит записи ВСЕХ кейсов.</b> Отрицанию {@code B8.12}
 * («токен наружу не выходит») это не мешает — оно абсолютное по предмету.
