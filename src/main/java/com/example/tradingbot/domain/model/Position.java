...
public class Position {
    ...
    private List<PositionCloseOrderAlgo> closeOrderAlgo;
    ...
    public List<PositionCloseOrderAlgo> getCloseOrderAlgo() {
        return closeOrderAlgo;
    }

    public void setCloseOrderAlgo(List<PositionCloseOrderAlgo> closeOrderAlgo) {
