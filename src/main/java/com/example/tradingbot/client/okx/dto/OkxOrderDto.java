...
public class OkxOrderDto {
    ...
    private List<OkxOrderAttachAlgoDto> attachAlgoOrds;
    private String algoClOrdId;
    private String algoId;
    private OkxOrderLinkedAlgoDto linkedAlgoOrd;
    ...
    public List<OkxOrderAttachAlgoDto> getAttachAlgoOrds() {
        return attachAlgoOrds;
    }

    public void setAttachAlgoOrds(List<OkxOrderAttachAlgoDto> attachAlgoOrds) {
    ...
    public OkxOrderLinkedAlgoDto getLinkedAlgoOrd() {
        return linkedAlgoOrd;
    }

    public void setLinkedAlgoOrd(OkxOrderLinkedAlgoDto linkedAlgoOrd) {
