...
public class OkxBalanceAccountDto {
    ...
    private List<OkxBalanceDetailDto> details;
    ...
    public List<OkxBalanceDetailDto> getDetails() {
        return details;
    }

    public void setDetails(List<OkxBalanceDetailDto> details) {
