...
public class OkxPositionDto {
    ...
    private List<OkxPositionCloseOrderAlgoDto> closeOrderAlgo;
    ...
    public List<OkxPositionCloseOrderAlgoDto> getCloseOrderAlgo() {
        return closeOrderAlgo;
    }

    public void setCloseOrderAlgo(List<OkxPositionCloseOrderAlgoDto> closeOrderAlgo) {
