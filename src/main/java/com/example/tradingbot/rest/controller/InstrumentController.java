...
import com.example.tradingbot.rest.model.Instrument;
...
public class InstrumentController {
    ...
    @PostMapping
    public Instrument createInstrument(@PathVariable(name = "exchangeName") String exchangeName,
    ...
    @GetMapping
    public List<Instrument> getAllByExchange(@PathVariable(name = "exchangeName") String exchangeName) {
    ...
    public Instrument getByName(@PathVariable(name = "exchangeName") String exchangeName,
