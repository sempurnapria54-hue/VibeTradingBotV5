...
public class BalanceAccountRest {
    ...
    private List<BalanceDetailRest> details;
    ...
    public List<BalanceDetailRest> getDetails() {
        return details;
    }

    public void setDetails(List<BalanceDetailRest> details) {
