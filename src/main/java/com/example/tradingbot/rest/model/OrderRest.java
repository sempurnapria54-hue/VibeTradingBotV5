...
public class OrderRest {
    ...
    private List<OrderAttachAlgoRest> attachAlgoOrds;
    private String algoClOrdId;
    private String algoId;
    private OrderLinkedAlgoRest linkedAlgoOrd;
    ...
    public List<OrderAttachAlgoRest> getAttachAlgoOrds() {
        return attachAlgoOrds;
    }

    public void setAttachAlgoOrds(List<OrderAttachAlgoRest> attachAlgoOrds) {
    ...
    public OrderLinkedAlgoRest getLinkedAlgoOrd() {
        return linkedAlgoOrd;
    }

    public void setLinkedAlgoOrd(OrderLinkedAlgoRest linkedAlgoOrd) {
