...
public interface IntegrationService {
    ...
    /**
     * Все живые позиции счёта одним запросом — вход обходов, которым
     * нужен срез по МНОЖЕСТВУ инструментов. Поштучное чтение того же
     * факта упирается в лимит частоты источника: у эндпоинта позиций он
     * общий с торговой петлёй, а обход растёт с числом инструментов
     * (docs/integrations/okx/contracts/position.md). Позиций нет —
     * пустой список, не null.
     */
    List<PositionExternalSnapshot> getPositions();
