...
|-----------------------------------------------|-----------------------|---------------------------------------------------------------------|---------|----------------------------------------------------------------------------|---------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|
| Получить баланс (snapshot)                    | REST                  | `GET /api/v5/account/balance?ccy=USDT`              | Private | стартовая синхронизация окружения (деньги), контроль риска                 | Можно брать только нужные валюты через `ccy`                                    | [Получить баланс](Получить%20баланс%20REST.md)                                                               | [Маппинг в доменную модель](../../deprecated/models/domain/old/Balance.md)           |
