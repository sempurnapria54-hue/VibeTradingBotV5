...
templates/                   Templates (documents/ — markdown-document templates: adr.md, model.md, lifecycle.md, process.md, integration-mapping.md, reference.md, invariant.md, open-questions-journal.md; per ADR-0004, ADR-0005, ADR-0008)
